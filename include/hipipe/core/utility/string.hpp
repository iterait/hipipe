...
template<>
inline std::string string_to<std::string>(const std::string& str)
{
    return str;
}
...
template<>
inline bool string_to<bool>(const std::string& str)
{
...
inline std::string to_string(const std::experimental::filesystem::path& path)
{
    return path.string();
}
