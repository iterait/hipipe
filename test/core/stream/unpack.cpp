...
BOOST_AUTO_TEST_CASE(test_unpack_dim0)
{
    ...
    std::tie(unp_int, unp_intvec) =
      hipipe::stream::unpack(rgv::move(data), from<Int, IntVec>, dim<0>);
...
BOOST_AUTO_TEST_CASE(test_unpack_dim1)
{
    ...
    std::tie(unp_int, unp_intvec) =
      hipipe::stream::unpack(rgv::move(data), from<Int, IntVec>);
...
BOOST_AUTO_TEST_CASE(test_unpack_dim2)
{
    ...
    unp_intvec = hipipe::stream::unpack(rgv::move(data), from<IntVec>, dim<2>);
